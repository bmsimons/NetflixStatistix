...
public class UserInterface implements Runnable {
    ...
    public void createComponents(Container container) {
        ...
        // ActionListeners
        programButton.addActionListener(new ProgramActionListener(this, centerPanel, topPanel));
        profileButton.addActionListener(new ProfileActionListener(this, centerPanel, topPanel));
