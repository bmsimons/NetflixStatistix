...
public class ProfileAddSeriesSearchActionListener implements ActionListener {
    private ProfileAddSeriesWatchedPanel panel;

    public ProfileAddSeriesSearchActionListener(ProfileAddSeriesWatchedPanel panel) {
        this.panel = panel;
    }
